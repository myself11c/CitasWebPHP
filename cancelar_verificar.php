                    ...
                    <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                        <div class="card card-plain mt-8">
                            <div class="card-header pb-0 text-left bg-transparent">
                                ...
                                <p class="mb-0"> A Continuación, encontrara el listado de citas.  </p>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form role="form" id="inf_pac">
                                        ...
                                        <div class="text-center">
                                            <button type="button" onclick="historialCitas()" class="btn bg-gradient-info w-100 mt-4 mb-0">Iniciar</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="card card-frame" id="resultado"></div>
